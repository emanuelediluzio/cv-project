...
#Combined Model based on the two finetuned ResNet50
class DualResNetForPollution(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.fc3_regression = nn.Linear(256, num_classes)  #Regression for NO2 level
    ...
    def forward(self, x1, x2):
        ...
        #Output for regression, classification on pollution(polluted/not polluted) and area classification
...
def save_checkpoint(epoch, model, optimizer, loss, directory="Checkpoints"):
...
checkpoint_dir = "/work/cvcs2024/air_pollution_prediction/Checkpoints"
